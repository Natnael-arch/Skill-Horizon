        ...
        <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
          ...
          <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
            <h1>
              {props.heading ?? (
                <Fragment>
                  <span className="navbar8-text24">Heading</span>
                </Fragment>
              )}
            </h1>
            <nav className="navbar8-links1">
              ...
              >
                {props.link1 ?? (
                  <Fragment>
                    <span className="navbar8-text19">Link 1</span>
                  </Fragment>
                )}
              </a>
              <a
              ...
              >
                {props.link2 ?? (
                  <Fragment>
                    <span className="navbar8-text20">Link 2</span>
                  </Fragment>
                )}
              </a>
              <div
            ...
            <div className="navbar8-nav">
              ...
              <nav className="navbar8-links2">
                ...
                >
                  {props.link3 ?? (
                    <Fragment>
                      <span className="navbar8-text18">Link 3</span>
                    </Fragment>
                  )}
                </a>
                <div className="navbar8-link4-accordion">
                  ...
                  >
                    <span className="thq-link thq-body-small">
                      {props.link4 ?? (
                        <Fragment>
                          <span className="navbar8-text28">Link 4</span>
                        </Fragment>
                      )}
                    </span>
                  ...
                  <div className="navbar8-menu-item6">
                    ...
                    <div className="navbar8-content6">
                      <span className="navbar8-page22 thq-body-large">
                        {props.page2 ?? (
                          <Fragment>
                            <span className="navbar8-text14">Page Two</span>
                          </Fragment>
                        )}
                      </span>
                      <span className="thq-body-small">
